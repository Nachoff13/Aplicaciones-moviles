...
class EditCityActivity : ComponentActivity() {
        ...
        setContent {
            TP2APP2Theme {
                Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
                    EditCityScreen(modifier = Modifier.padding(innerPadding))
                }
            }
        }
    }
...
@Composable
fun EditCityScreen(modifier: Modifier = Modifier) {
